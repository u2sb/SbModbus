...
{
  /// <summary>netstandard2.0/2.1 的 InterpolatedStringHandler polyfill</summary>
  [AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct)]
  internal sealed class InterpolatedStringHandlerAttribute : Attribute
  {
  }

  /// <summary>netstandard2.0/2.1 的 InterpolatedStringHandlerArgument polyfill</summary>
...
public ref struct LoggerInterpolatedStringHandler
{
  ...
  public readonly string GetResult() => _builder?.ToString() ?? string.Empty;
}
...
public static class Logger
{
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static bool IsEnabled(LogLevel level) => level >= Level && Output != null;
  ...
  /// <inheritdoc cref="Log(SbModbus.LogLevel,ref SbModbus.LoggerInterpolatedStringHandler)" />
