...
//   {
//     // 写入数据
//     await System.IO.Stream.WriteAsync(data);
//     await System.IO.Stream.FlushAsync();
//
//     if (!System.IO.Stream.CanRead) throw new ModbusException("Stream can not read");
//
//     if (ClearReadBufferAsync != null)
//       await ClearReadBufferAsync.Invoke(System.IO.Stream, CancellationToken.None);
//
...
//       {
//         // 先设置到最后一位
//         if (System.IO.Stream.CanSeek) System.IO.Stream.Seek(0, SeekOrigin.End);
//
...
//         {
//           var read = await System.IO.Stream.ReadAsync(memory[bytesRead..], ct);
//
//           // 如果没读到数据就跳过
//           if (read == 0) continue;
//
