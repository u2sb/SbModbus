...
{
  public const string ModbusClient_0x01_IllegalFunction =
  ...
  public const string ModbusClient_0x02_IllegalDataAddress =
  ...
  public const string ModbusClient_0x03_IllegalDataValue =
  ...
  public const string ModbusClient_0x03_IllegalDataValue_0x7B =
  ...
  public const string ModbusClient_0x03_IllegalDataValue_0x7D =
  ...
  public const string ModbusClient_0x03_IllegalDataValue_0x7D0 =
    "The quantity of coils is out of range (1..2000).";

  public const string ModbusClient_0x04_ServerDeviceFailure =
    "An unrecoverable error occurred while the server was attempting to perform the requested action.";

  public const string ModbusClient_0x05_Acknowledge =
    "The server has accepted the request and is processing it, but a long duration of time will be required to do so.";

  public const string ModbusClient_0x06_ServerDeviceBusy =
    "The server is engaged in processing a long–duration program command.";

  public const string ModbusClient_0x08_MemoryParityError =
    "The server attempted to read record file, but detected a parity error in the memory.";

  public const string ModbusClient_0x0A_GatewayPathUnavailable =
  ...
  public const string ModbusClient_0x0B_GatewayTargetDeviceFailedToRespond =
    "No response was obtained from the target device";

  public const string ModbusClient_InvalidUnitIdentifier =
  ...
  public const string Modbus_InvalidValueUShort =
    "The value is invalid. Valid values are in the range of 0 - 65535.";

  public const string ModbusClient_Unknown_Error =
