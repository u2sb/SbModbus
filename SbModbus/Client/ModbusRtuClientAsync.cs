...
namespace SbModbus.Client
{
  public partial class ModbusRtuClient
  {
    ...
    public override async ValueTask WriteMultipleRegistersAsync(int unitIdentifier, int startingAddress, Memory<byte> data)
    {
    ...
    /// <returns></returns>
    protected override async ValueTask<Memory<ushort>> ReadRegistersAsync(int unitIdentifier, ModbusFunctionCode functionCode,
