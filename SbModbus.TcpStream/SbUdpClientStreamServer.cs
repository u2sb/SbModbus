...
/// </summary>
public class SbUdpClientStreamServer : IModbusStreamServer
{
  ...
  /// <summary>
  ///   获取底层 UDP 客户端流（用于直接访问连接配置）
  /// </summary>
  public SbUdpClientStream Stream { get; }
  ...
  public void Start()
  {
    if (_isDisposed) throw new SbModbusException("UDP client server stream has been disposed");
